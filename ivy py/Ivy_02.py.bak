...
#time function
        ...
        if "mailey" in recipient:
            ...
            mail_sendmail('sender_email','receiver_email', content)
            mail.close()
...
#change_wallpaper function
        ...
        urllib.urlretrieve(photo, "/Users/vuquoccuong121994/Documents/wallpaper/a") #this will be the location for image to be downloaded
        subprocess.call(["killall Dock"], shell = Truse)
...
#ask_me_anything function
        ...
        try:
            if reg_ex:
                ...
                print(e)
                IvyResponse(e)
        IvyResponse('Hi there, I am Ivy and I am your personal Voice assistant! I am here to help you with your daily task so you can be more focused on your life purpose. Please ask me anything or say "Help me" and I will tell you what all I can do for ya.')
